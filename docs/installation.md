...
# stage-release prints the computed release ID; pass it to the next commands.
looper upgrade activate-release --release-root <dir> --release <release-id>
looper upgrade verify-start --release-root <dir> --release <release-id>
```
