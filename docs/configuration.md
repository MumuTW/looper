...
- `forgejo` — REST-backed MVP for planner, worker, summary-comment reviewer flows, and manual/direct native-review-comment fixer runs. Forgejo projects are config-driven and do not require `gh` in Forgejo-only installs.
