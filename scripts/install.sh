...
log "  2. Write ~/.looper/config.toml — see docs/configuration.md"
log "  3. Run: looperd"
log "  4. Register a project via the dashboard or POST /api/v1/projects"
log "  5. Control loops: looper stop|close|takeover|handback|retry|start|pause|respond"
