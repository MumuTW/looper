...
>
> `looper init|status|dashboard|project add|project list|project discover|gatekeeper agreements|gatekeeper verdicts|gatekeeper promote|start|pause|retry|stop|close|takeover|handback|respond|version`
>
