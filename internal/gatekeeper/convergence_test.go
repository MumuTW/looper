...
func TestEvaluatePullRequestConvergenceFloorIgnoresBelowFloorItems(t *testing.T) {
	fixture := newGatekeeperFixture(t)
	seedReviewerConvergenceLoop(t, fixture, `{"convergence":{"policy":{"maxConsecutiveUnproductive":3,"maxFixerAttemptsPerItem":4,"maxTotalRounds":40,"severityFloor":"blocking"},"state":{"totalRounds":2,"items":{"nit-1":{"id":"nit-1","severity":"nit","status":"open"}}},"action":"complete","reason":"severity_floor_reached","status":"completed"}}`, 1)
...
func TestEvaluatePullRequestBlocksAwaitingHumanConvergence(t *testing.T) {
	fixture := newGatekeeperFixture(t)
	seedReviewerConvergenceLoop(t, fixture, `{"convergence":{"policy":{"maxConsecutiveUnproductive":3,"maxFixerAttemptsPerItem":4,"maxTotalRounds":40,"severityFloor":"blocking"},"state":{"totalRounds":4},"action":"escalate","reason":"absolute_round_ceiling","status":"awaiting_human"}}`, 1)
...
func TestDiscoverPullRequestsReevaluatesBlockedConvergence(t *testing.T) {
	...
	seedReviewerConvergenceLoop(t, fixture, `{"convergence":{"policy":{"maxConsecutiveUnproductive":3,"maxFixerAttemptsPerItem":4,"maxTotalRounds":40,"severityFloor":"non_blocking"},"state":{"totalRounds":3,"items":{"blocking-1":{"id":"blocking-1","severity":"blocking","status":"open"}}},"action":"continue","reason":"converging","status":"active"}}`, 1)
	...
	seedReviewerConvergenceLoop(t, fixture, `{"convergence":{"policy":{"maxConsecutiveUnproductive":3,"maxFixerAttemptsPerItem":4,"maxTotalRounds":40,"severityFloor":"non_blocking"},"state":{"totalRounds":4,"items":{"blocking-1":{"id":"blocking-1","severity":"blocking","status":"resolved"}}},"action":"complete","reason":"severity_floor_reached","status":"completed"}}`, 1)
