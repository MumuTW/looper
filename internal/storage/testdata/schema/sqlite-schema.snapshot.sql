...
-- Generated by applying migrations 0001 through 0021 in lexical order
...
CREATE INDEX idx_event_logs_triage_source_latest
...
CREATE UNIQUE INDEX idx_runs_seq ON runs (seq);
