...
// the agent pipes it in. Callers set CommitID, which is the field each case
// varies.
func reviewSubmitTestOptions(t *testing.T, payloadPath, configPath, cwd string, stdout, stderr *bytes.Buffer) Options {
	t.Helper()
