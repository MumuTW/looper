...
func canonicalRoundTripFixtureConfig() Config {
	...
	return Config{
		...
		Scheduler:     SchedulerConfig{PollIntervalSeconds: 45, MaxConcurrentRuns: 7, RetryMaxAttempts: 9, ConsecutiveFailureThreshold: 3, RetryBaseDelayMS: 1500, SlowLaneWarnThresholdMS: 2500, DiscoveryCacheTTLSeconds: 12},
		...
		Providers: []ProviderConfig{{ID: "ghes-main", Kind: ProviderKindGitHub, BaseURL: "https://ghe.example.test", TokenEnv: stringPtr("GHES_TOKEN")}},
